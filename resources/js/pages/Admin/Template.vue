...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 show_list">
            ...
            <div class="card card-body" v-for="item in templates.data" :editId="item.id">
               ...
               <div style="text-align:left;" v-if="item.user_id === ownerId">
                   your post
               </div>
               <div style="text-align:right;">
                   <div class="btn-group">
                    <button class="btn btn-primary" @click.prevent="editTemplate(item.id)">Edit</button>
