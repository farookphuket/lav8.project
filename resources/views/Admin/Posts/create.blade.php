...
<script>
    $(function(){
            ...
            // to enable summernote just un-comment the above code
            // you may have to comment out Jodit 

            let exce = new Jodit('.post_excerpt',{
                    height: 550,
                    'placeholder': `Howdy ${my_name} this is you post excerpt`
                });

            let body = new Jodit('.post_body',{
                    placeholder: 'this is the body of post',
                    height:550
                });
        });
</script>
